const CONFIG = {
  ...
  COMMERCE_TEXT_CENTER_TITLE: 'Tianxiyou’s Blog', // 中间产品区块标题
  COMMERCE_TEXT_CENTER_DESCRIPTION:
    '阅尽天下贪婪事，回望此时正枉生。', // 中间产品区块文字描述
  COMMERCE_TEXT_CENTER_CATEGORY_TITLE: 'Blog Categories', // 左侧产品分类标题
  COMMERCE_TEXT_FOOTER_TITLE: '联系我', // COMMERCE主题页脚文案标题；按Shift+Enter键可以换行
  COMMERCE_TEXT_FOOTER_MENU_1: '分类', // COMMERCE主题页脚左侧菜单标题1
  COMMERCE_TEXT_FOOTER_MENU_2: '关于我', // COMMERCE主题页脚左侧菜单标题2
