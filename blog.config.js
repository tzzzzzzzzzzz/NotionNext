...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '8be0ec3628b34b08a3510d308b2da3b0',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TianXiYou', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || ' 社畜、京吹、LOLer、编程猿、卷毛', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tianxiyoublog.vip.cpolar.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 杂想, 漫谈', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tz1063659575@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/tzzzzzzzzzzz', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/dollsfrontline/dsr50_1801/destroy/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://tianxiyoublog.vip.cpolar.cn', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
